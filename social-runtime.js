(() => {
  ...
  style.textContent = `
    ...
    .social-product-final{object-fit:contain;object-position:center;opacity:0}
    ...
    @media(prefers-reduced-motion:reduce){
      ...
      .social-product-final{opacity:1!important}
  ...
  showcase.setAttribute('aria-label', 'SocialPlatform release moving through database and web layers before resolving back into the product');
  showcase.innerHTML = `
    <div class="social-motion-root">
      <div class="social-product-plane">
        ...
        <img class="social-product-final" src="${assets.signoff}" alt="SocialPlatform moderation rules screen" />
      </div>
  ...
  const finalProduct = showcase.querySelector('.social-product-final');
  ...
  const finalGeometry = [
    [116,90,884,90], [884,90,884,482], [884,482,116,482], [116,482,116,90],
    [116,136,884,136], [180,190,820,190], [180,230,750,230], [180,270,802,270],
    [180,330,528,330], [552,330,820,330], [180,370,710,370], [180,410,790,410],
    [908,442,884,442], [884,442,884,410], [146,114,174,114], [184,114,212,114]
  ];
  ...
  function render() {
    ...
    if (p < .51) {
      ...
      geometry = interpolateGeometry(endCollapsed, finalGeometry, finalFrame * (1 - finalIn * .35));
      geometryOpacity = finalFrame * (1 - finalIn * .7);
    }
